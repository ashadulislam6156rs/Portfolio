        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.p
              ...
              className={`mt-2  leading-relaxed max-w-lg mx-auto lg:mx-0 text-[#0000009f] dark:text-slate-400`}
            >
            ...
            <motion.div
              ...
              className="flex justify-center lg:justify-start items-center space-x-4 mt-6"
            >
              {/* Facebook */}
              <motion.a
                variants={{
            ...
            <motion.a
              ...
              href="/Mern_Stack_Developer_Resume.pdf"
              download
            >
              <FaDownload />
              Download Resume
          ...
          >
            <motion.div
              ...
              className="w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 relative"
            >
              <div className="absolute inset-0 bg-[#04bfff] blur-2xl opacity-70 rounded-full"></div>

              <div className="relative flex items-center justify-center">
                <div className="absolute w-full aspect-square rounded-full bg-gradient-to-br from-[#04bfff] to-[#04c0ffb7] opacity-30 animate-[spin_20s_linear_infinite]"></div>
                <div className="absolute w-[95%] aspect-square rounded-full border-4 border-dashed border-[#04bfff] animate-[spin_30s_linear_infinite_reverse]"></div>

                <div className="relative p-4 bg-[#04c0ffb6] rounded-full shadow-2xl">
                  <div className="p-6 bg-[#d0d1ce] rounded-full">
                    <img
                      src={MyImage}
                      alt="Ashadul Islam"
